      ...
      <Router>
        <div style={{ margin: '8px', fontFamily: 'sans-serif' }}>
          <header style={{ borderBottom: '1px solid black'}}>
            ...
            {web3.loaded ? (
              <>
                <span>Connecté avec {web3.walletAddress}</span>
                <button onClick={web3.unloadWallet}>Déconnexion</button>
              </>
            ) : <button onClick={web3.loadWallet}>Connexion</button>}
          </header>
            ...
            <Route path="/" exact>
              <main>
                ...
                <p>
                  ...
                  <br/>
                  Pour vous simplifier la tâche (et parce que nous sommes là pour la blockchain et non React), cette application web
